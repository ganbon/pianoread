from horizonal_line.img_collector import ImageCollector
from horizonal_line.detect_stf import StfDetector
from horizonal_line.detect_para import ParagraphDetector
from horizonal_line.paragraph import Paragraph
import cv2
...
class Score:
    ...
    def labeling(self):
        ...
        # テスト用出力
        #cv2.imwrite('../result2/lineout/test'+str(i)+'.png', self._img2)

        self._img3 = self._img2.copy()
        _img2=self._img2.copy()
        result = []
